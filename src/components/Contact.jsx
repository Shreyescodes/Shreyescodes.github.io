                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="mailto:shreyastc19@gmail.com" className="text-gray-600 hover:text-indigo-600">
                        shreyastc19@gmail.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="tel:+919844000365" className="text-gray-600 hover:text-indigo-600">
                        +91 9844000365
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">Bengaluru, KA</p>
                    </div>
                  </div>
                </div>
              </div>
